...
class RegisterRentalScreen extends StatefulWidget {
  const RegisterRentalScreen({super.key});

  @override
  State<RegisterRentalScreen> createState() => _RegisterRentalScreenState();
}

class _RegisterRentalScreenState extends State<RegisterRentalScreen> {
  @override
        ...
        bottomNavigationBar: Container(
          ...
          child: SizedBox(
            child: ElevatedButton(
              onPressed: () {
                Get.to(() => const ImageRentalScreen());
              },
